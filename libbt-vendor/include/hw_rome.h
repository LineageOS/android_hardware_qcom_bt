...
#define ROME_FW_PATH                      "/vendor/etc/firmware/rampatch.img"
#define ROME_RAMPATCH_TLV_PATH            "/vendor/etc/firmware/rampatch_tlv.img"
#define ROME_NVM_TLV_PATH                 "/vendor/etc/firmware/nvm_tlv.bin"
#define ROME_RAMPATCH_TLV_1_0_3_PATH      "/vendor/etc/firmware/rampatch_tlv_1.3.tlv"
#define ROME_NVM_TLV_1_0_3_PATH           "/vendor/etc/firmware/nvm_tlv_1.3.bin"
#define ROME_RAMPATCH_TLV_2_0_1_PATH      "/vendor/etc/firmware/rampatch_tlv_2.1.tlv"
#define ROME_NVM_TLV_2_0_1_PATH           "/vendor/etc/firmware/nvm_tlv_2.1.bin"
